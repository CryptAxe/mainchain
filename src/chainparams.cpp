...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x0000001981aaebd7631195c050ea09f2c4a1f486b59cf2f190a6c4a27df59a5e");
        ...
        genesis = CreateGenesisBlock(1576027599, 81532189, 0x1d5fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        assert(consensus.hashGenesisBlock == uint256S("0x0000001981aaebd7631195c050ea09f2c4a1f486b59cf2f190a6c4a27df59a5e"));
        ...
        checkpointData = {
            {
                { 0, uint256S("0x0000001981aaebd7631195c050ea09f2c4a1f486b59cf2f190a6c4a27df59a5e")},
            }
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1576442777, 2, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        // PoW: 5f7b23e5c858849788406fd2e18dabaff85afdd7d6efbcdff4bc91550ecff6d9
        assert(consensus.hashGenesisBlock == uint256S("0x029a34757f2edb7f50455ccdc0ed77850d3e1a2723d5813d28d0035ce4881790"));
        assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
        ...
        checkpointData = {
            {
                {0, uint256S("029a34757f2edb7f50455ccdc0ed77850d3e1a2723d5813d28d0035ce4881790")},
            }
        };
